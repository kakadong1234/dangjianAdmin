    ...
    function($scope, $http) {
        ...
        $scope.load=function(){
                ...
                $scope.tijiao=function () {
                    ...
                    // $http({
                    //     method:'post',
                    //     url:'http://api.lpszzb.gov.cn:8443/cadre',
                    //     data:{
                    ...
                    $http.post("http://api.lpszzb.gov.cn/cadre?user_id="+$scope.user_id+"&longitude="+Number($scope.jingdu)+"&latitude="+Number($scope.weidu))
                        .then(function (res) {
                            window.location.href="ganbu_manage.html"
                        })
                }
